      ...
      <Drawer variant="permanent" open={open}>
        <DrawerHeader>
          ...
          <IconButton onClick={handleDrawerClose}>
            {theme.direction === "rtl" ? (
              <ChevronRightIcon style={{color:'white', backgroundColor:'black'}}/>
            ) : (
              <ChevronLeftIcon style={{color:'white', backgroundColor:'black'}} />
            )}
          </IconButton>
        </DrawerHeader>
        ...
        <List>
          {/* List Item 1 */}
          <ListItem disablePadding sx={{ display: "block", "&:hover": { backgroundColor: "#3f5178" } }}>
            <ListItemButton
              sx={{
                minHeight: 48,
            ...
            >
              ...
              >
                <PersonSearchIcon style={{color:"gray", backgroundColor:'#2c4171'}} />
              </ListItemIcon>
              <ListItemText
                primary="Search User"
          ...
          <ListItem disablePadding sx={{ display: "block", "&:hover": { backgroundColor: "#3f5178" } }}>
            ...
            >
              ...
              >
                <PageviewIcon style={{color:"gray", backgroundColor:'#2c4171'}} />
              </ListItemIcon>
              <ListItemText
